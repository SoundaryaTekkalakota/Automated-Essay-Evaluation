...
public class WordNetDict
{
	...
	public static void main(String args[]) throws IOException {
		WordNetDict inst = new WordNetDict();
		inst.getNounsOrVerbs("gone");
...
private WordNetDict() throws IOException
{
	initial();
	wordNetDict.open();
}

public static WordNetDict getInstance() throws IOException
{
...
public void initial()
{
 ...
 //   wordNetDict = (IDictionary) Dictionary.getInstance();
...
public String getStem(String word)
{
	...
	if (wnStemmer.findStems(word, null).size() > 0)
	{
		resultword= wnStemmer.findStems(word, null).get(0);
...
public boolean isCorrectWord(String word)
{
	...
	return wmStemmer.findStems(word, null).size() >0;
}
